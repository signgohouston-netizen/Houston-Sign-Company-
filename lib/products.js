...
export const products = [
  ...
  // ---- Added to match demand & competitor coverage ----
  { slug: 'neon-signs', name: 'Neon & LED Neon Signs', category: 'Custom', short: 'Custom neon-style signs with a warm, eye-catching glow.', desc: 'Modern LED neon delivers the classic neon look with lower energy use and longer life — perfect for restaurants, bars, salons, and feature walls that get noticed and photographed.' },
  { slug: 'menu-boards', name: 'Menu Boards', category: 'Indoor', short: 'Indoor menu boards and digital menu displays.', desc: 'Clear, on-brand menu boards for restaurants, cafes, and c-stores — printed or digital so you can update items and prices fast.' },
  { slug: 'real-estate-signs', name: 'Real Estate Signs', category: 'Outdoor', short: 'Yard, post & panel, and rider signs for agents.', desc: 'Durable, professional real estate signage — yard signs, post-and-panel listings, and riders — that helps properties move and keeps your branding consistent.' },
  { slug: 'construction-signs', name: 'Construction Site Signs', category: 'Outdoor', short: 'Site, project, and safety signage for job sites.', desc: 'Weather-tough construction and project signage — site boards, developer signs, and safety/regulatory signs built to last through the build.' },
];

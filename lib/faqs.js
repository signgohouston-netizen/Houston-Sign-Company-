...
export const homeFaqs = [
  { q: 'What does Sign Go do?', a: 'Sign Go is a factory-direct sign company in Houston. We design, manufacture, permit, and install custom signs — indoor and outdoor signs, channel letters, full-color LED displays, monument and pylon signs, vehicle wraps, banners, and more — and we ship nationwide.' },
  { q: 'How much does a custom sign cost?', a: 'Pricing depends on the sign type, size, materials, lighting, and installation, so there is no flat rate. Because we manufacture in-house, our factory-direct pricing is competitive. Request a free quote and we will give you clear, itemized pricing.' },
  { q: 'Do you offer free quotes?', a: 'Yes — every quote is free and no-obligation. Call 281-814-1111, use our contact form, or chat with our AI assistant to get started.' },
  { q: 'What areas does Sign Go serve?', a: 'We serve Houston and 45+ surrounding cities — including Katy, Cypress, Sugar Land, Spring, The Woodlands, Pearland, and more — across Harris, Fort Bend, Waller, Montgomery, Austin, and Brazoria counties. As a manufacturer, we also ship custom signs nationwide.' },
  { q: 'Do you make and install the signs yourselves?', a: 'Yes. Everything is handled in-house by one team — design, fabrication, and professional installation by our own crews. No middleman, no handoffs.' },
  { q: 'How long does a sign take?', a: 'Most signs are designed, produced, and installed within one to three weeks depending on complexity, permits, and approvals. Vinyl banners and decals can be much faster — tell us your deadline.' },
];

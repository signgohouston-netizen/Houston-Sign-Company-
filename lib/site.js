...
export const site = {
  ...
  // Google reviews — fill these with your real numbers/links to go live.
  googleReviewsUrl: '', // link to your Google Business Profile reviews
  googleRating: '', // e.g. '4.9'
  googleReviewCount: '', // e.g. '180'

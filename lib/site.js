...
export const site = {
  ...
  // "Write a review" short link from Google Business Profile → "Ask for reviews"
  // (looks like https://g.page/r/XXXX/review). Sends customers straight to the
  // review form. Leave blank to fall back to googleReviewsUrl, then to a Google
  // Maps search for the business.
...
// Google links derived from the info above (footer review button + map).
export const googleLinks = {
  ...
  directions: `https://www.google.com/maps/dir/?api=1&destination=${site.mapQuery}`,
  embed: `https://www.google.com/maps?q=${site.mapQuery}&output=embed`,
};
